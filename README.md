...
<body>
  ...
  <div class="container" id="main-container">
    <h1 id="slide-title">Haiii Selamat Datang orang imut! 🌷</h1>
    <p id="slide-content">Klik tombol di bawah ini yaa, cantikk 💕</p>
    <button onclick="nextSlide()" id="next-btn">Next</button>
  </div>
  ...
  <div class="letter-container" id="letter">
    ...
    aaaa lucuu bangett dehh 😭  
    intinya, kita lucu, unik, gitu gituu dahh 💖  
    intinya, aku sayang Shayna sih intinya,  
    kek, hehehe cuma bisa ngasih segini  
  ...
  <script>
    ...
    const slides = [
      { title: "Haiii Selamat Datang!", content: "Selamat datang, Shayna! Klik disinii ya! 🌟" },
      { title: "US", content: "liatt siapa inii?! cuma kitaa, dua manusia paling random tapi paling cocok 😆" },
      { title: "Selamat Ulang Tahun!", content: "Happy Birthday, sayangkuhh, my moonshine 😘" },
      { title: "Sweetheart", content: "Kamu lucu, gaa boong, kamu tuhh ya bener benerr cantikk! ❤️" },
      { title: "Wishhh", content: "Semoga kitaa bisaa terus terusan bareng yahh, semuanya bareng, pokoknya harus tetep bareng teruss gamauu bocah dari caynaa 🎉" },
      { title: "Pesan Kecil", content: "Kamu tuhh gausah berubah apa apa, udah perfect banget, cukup jadi kamu aja yang selalu bikin aku senyum tiap hari 💖" },
      { title: "Surat Khusus", content: "Ada surat buat kamu! Klik 'Buka Surat' di bawah.", isLetter: true }
    ];
